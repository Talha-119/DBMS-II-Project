...
// procedure and the state report every scenario prints. The array order is
// the run order, not the filename order — `full` needs the extra demo
// identities loaded before it can file applications with them.
//
