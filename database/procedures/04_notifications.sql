...
-- readable afterwards. trg_notify_deletion_decided still fires exactly as
-- before — it reads bc_no from the application row, which now survives the
-- approval rather than racing it.
-- ----------------------------------------------------------------------------
